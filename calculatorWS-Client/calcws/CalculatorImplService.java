 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://calcws", wsdlLocation = "http://localhost:8889/calculatorWS/services/CalculatorImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://calcws", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8889/calculatorWS/services/CalculatorImpl?wsdl");
    ...
    public CalculatorImpl getCalculatorImpl() {
        return super.getPort(new QName("http://calcws", "CalculatorImpl"), CalculatorImpl.class);
    }
    ...
    public CalculatorImpl getCalculatorImpl(WebServiceFeature... features) {
        return super.getPort(new QName("http://calcws", "CalculatorImpl"), CalculatorImpl.class, features);
    }
